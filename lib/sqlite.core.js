...
SQLitePluginTransaction.prototype.run = function() {
  ...
  plugin.exec(plugin.sqlitePlugin.EXEC_ON_MAIN_THREAD ? "executeSqlBatch" : "backgroundExecuteSqlBatch", {
    dbargs: {
...
SQLiteFactory.prototype.execOnMainThread = function(execOnMainThread) {
  plugin.sqlitePlugin.EXEC_ON_MAIN_THREAD = execOnMainThread;
}
